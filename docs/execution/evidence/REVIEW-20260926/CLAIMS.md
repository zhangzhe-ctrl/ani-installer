...
| 21 | a bare clone fails exactly one material-dependent test | `docs/execution/REVIEW-20260926.md` §6 | `TestChartSpecsMatchTheApprovedLockAndTheChartBytes` | on branch (claim); reproducing needs `git clone` + charts absent |
